...
//в ООН имеется перечень встех стран, который включает:
//- название;
//- континент;
//- столицу;
//- площадьж
...
//- гос. строй.
//вывести названия и столицы государств в порядке убывания плотности населения,
//применив многопутевое двухфазное естественное слияние

interface

uses
  Windows, Messages, SysUtils, Variants, Classes, Graphics, Controls, Forms,
  Dialogs, Menus, StdCtrls, UFile, UInfo, USort;
  ...
  then
    ...
    begin
      mainFile.AddElem(InputInfo(edtName.Text,cbbContinent.Text,
        edtCapital.Text,StrToInt(edArea.Text),StrToInt(edPopulation.Text),
        cbbPoliticalSystem.Text));
